...
#ifndef __MLG_BNO055_H__
#define __MLG_BNO055_H__
...
class MLG_BNO055 
{
   public:
    ...
    MLG_BNO055 ( int32_t sensorID = -1, uint8_t address = BNO055_ADDRESS_A );
    ...
    bool readSensorData(adafruit_bno055_reg_t location, byte* buffer,  uint8_t length);
